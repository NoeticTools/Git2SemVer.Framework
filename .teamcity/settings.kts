...
project {
    ...
    features {
        githubIssues {
            id = "PROJECT_EXT_11"
            displayName = "NoeticTools/Git2SemVer.Framework"
            repositoryURL = "https://github.com/NoeticTools/Git2SemVer.Framework"
...
object BuildAndTest : BuildType({
    ...
    artifactRules = """
        ...
        +:SolutionVersioningProject/obj/Git2SemVer.Framework.log
